...
--
-- Hôte : 127.0.0.1
-- Généré le :  mer. 22 avr. 2020 à 18:44
...
('JT45109', 'Edmagh', 'khadija', 'cite dakhla , Agadir', 'agadir', '80000', '1234');
...
('AsIsSc08', 'Asimov', 'Isaac', 'Fondation', 'Science-fiction', '2070415708', 0),
('BaJaJu63', 'Barrie', 'James M.', 'Peter Pan', 'Junior', '2290333263', 1),
('DiPhSc43', 'Dick', 'Philip K.', 'Blade Runner', 'Science-fiction', '2290314943', 0),
('KaElRo58', 'Kazan', 'Elia', 'L’arrangement', 'Roman', '2234023858', 0),
('KuMiRo38', 'Kundera', 'Milan', 'La plaisanterie', 'Roman', '2070703738', 0),
('VeJuRo22', 'Verne', 'Jules', 'L île mysterieuse', 'Roman', '0812966422', 0),
('WaAlRo37', 'Walker', 'Alice', 'La couleur pourpre', 'Roman', '2290021237', 0);
